...
const Services = () => {
  return (
    <div className='container my-16 space-y-4'>
      { /* header section */}
      <div className='text-center max-w-lg max-auto space-y-2'>
        ...
        <p 
          ...
          className='text-sm opacity-50'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque, laudantium officia ad ipsam sit quia nobis dolor impedit tempora optio tenetur rerum ea dolorum repudiandae neque sapiente id deserunt voluptatibus.
        </p>
      </div>
