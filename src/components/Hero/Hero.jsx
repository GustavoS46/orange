                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[650px]">
                        ...
                        <div className='text-white mt-[100px] md:mt-0 p-4 space-y-4'>
                            ...
                            <p 
                                ...
                                data-aos-delay="500" 
                                className='text-sm'>
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ab nemo natus, velit fuga optio mollitia voluptatum odio voluptates consequuntur tenetur illo earum nobis dolore itaque corrupti? Eos accusantium ipsa accusamus?
                            </p>
                            <button 
                                data-aos="fade-up" 
                                data-aos-delay="700" 
